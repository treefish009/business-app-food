      ...
      <li v-for="item in goods" class="food-list food-list-hook">
        ...
        <ul>
          <li @click="selectFood(food,$event)" v-for="food in item.foods" class="food-item border-1px">
            <div class="icon" >
              <img width="57" heght="57" :src="food.icon">
            </div>
            <div class="content">
...
<script type="text/ecmascript-6">
  ...
  import cartcontrol from 'components/carcontrol/cartcontrol';
  ...
  export default{
    ...
    methods: {
      ...
      _initScroll() {
        this.meunSroll = new BScroll(this.$els.menuWrapper, {
          click: true
        });

        this.foodsSroll = new BScroll(this.$els.foodsWrapper, {
          click: true,
          probeType: 3
        });
